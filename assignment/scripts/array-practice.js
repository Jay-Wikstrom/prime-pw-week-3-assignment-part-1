...
let favoriteFoods = ['pizza', 'cheese burger', 'chicken nuggets', 'peanut butter and jelly sandwich'];
...
favoriteFoods.push('burrito');
console.log('Added a new food item to the end,', favoriteFoods);
...
console.log('Removed the last favorite food item', removedFood);
console.log('The favorite food list is now:', favoriteFoods);
...
console.log('Favorite food list is now:', favoriteFoods);
